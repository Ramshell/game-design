...
public class WinScreen extends ScreenAdapter {
    ...
    public WinScreen(MinionGame game) {
        this.game = game;
    ...
    public void render(float delta) {
        ...
        game.batch.draw(Assets.castle, 60, 120, 200, 200);
        game.batch.draw(Assets.bobFall.getKeyFrame(0, Animation.ANIMATION_LOOPING), 120, 200);
